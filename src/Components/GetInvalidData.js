...
class GetInvalidData extends Component {
    ...
    constructor(props){
     ...
     componentDidMount(){
        this.interval = setInterval(() => {
            UserService.getInvalidData().then((response) => {
...
render() {
    ...
    return (
             ...
             <div>
                  <h2>Air Quality Monitor Invalid Data</h2>
      ...
      <MDBDropdownMenu>
        ...
        <MDBDropdownItem link onClick={()=>{this.handleChange(3);this.handleSelect("Floor 3")}}>Floor 3</MDBDropdownItem>
                ...
                <table id = 'Invalid Data' className = "table table-striped">
                    <thead>
                        <tr>
